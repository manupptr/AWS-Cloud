...
**Task:** Creating the vpc with 1 public and private subnets attached to 1 public and private route tables and allowing the traffic from the internet gateway to public subnet and private subnet traffic allowed through NAT gateway
```
```
AWSTemplateFormatVersion: '2010-09-09'
